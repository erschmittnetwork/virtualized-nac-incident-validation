...
For associated GLPI GUI screenshots, see Section~\ref{sec:glpi-final-configuration}.
...
\begin{itemize}
    \item the pfSense terminal menu on boot and network GUI;
...
\begin{itemize}
    \item pfSense as the source of network traffic rules and logic;
...
% ---------------------------------------------------------------------
% SUBSECTION 11.7: SECTION CONCLUSION
% ---------------------------------------------------------------------
