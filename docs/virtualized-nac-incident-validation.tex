...
Its final-state configuration and deployment validation will be documented later (see Section~\ref{sec:appendix-a-ops-glpi-netplan-config}, Section~\ref{sec:glpi-final-configuration}, and the later GLPI figure screenshots in the incident section).
...
The authoritative manual transcription of the final pfSense interface summary is reproduced below and has an equivalent appendix reference (see Section~\ref{sec:appendix-a-pfsense-authenticated-interface-summary}).
...
These GUI-derived artifacts will be represented later through screenshots and appendix references rather than terminal transcription alone (see Section~\ref{sec:glpi-final-configuration} and the later incident section of this document).
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{screenshots/Wireshark_failed_8021x_ens38_pcap.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{screenshots/Wireshark_failed_8021x_ens39_pcap.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{screenshots/Wireshark_success_8021x_ens38_pcap.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{screenshots/Wireshark_success_8021x_ens39_pcap.png}
