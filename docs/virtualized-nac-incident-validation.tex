...
\hline
1.1 & 2026-03-30 & Formatting revisions for raw data and visual references and  & Eric Schmitt \\
\end{tabular}
\end{center}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.82\textwidth]{diagrams/reference-topology-diagram.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{assets/screenshots/pfSense_Interfaces_Terminal.png}
    \caption{pfSense interface assignments showing WAN, LAN/transit, OPT1 (services), and GUEST (OPT2)}
    \label{sec:fig-pfsense_interfaces_terminal}
\end{figure}
