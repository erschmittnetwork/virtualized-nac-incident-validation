...
The endpoint-side \texttt{wpa\_supplicant} service is active in the final steady state, which confirms that the endpoint is operating in a post-build state consistent with the intended access model.
