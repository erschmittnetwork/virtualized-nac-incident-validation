...
& access enforcement, incident simulation, automation, and packet-level validation \\
\hline
Primary Technologies & IEEE 802.1X via \texttt{hostapd} (wired mode) and \texttt{wpa\_supplicant}; pfSense; \\
& FreeRADIUS; GLPI on Apache and MariaDB; Splunk Universal Forwarder; Python; \\
& Ansible; \texttt{tcpdump}; Wireshark \\
\hline
